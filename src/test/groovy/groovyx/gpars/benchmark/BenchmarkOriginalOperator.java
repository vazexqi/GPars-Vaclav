...
public class BenchmarkOriginalOperator extends SimpleBenchmark {
    ...
    public void timeOperator(int reps) throws InterruptedException {
    ...
    public static void main(String[] args) throws Exception {
        Runner.main(BenchmarkOriginalOperator.class, args);
    }
}
